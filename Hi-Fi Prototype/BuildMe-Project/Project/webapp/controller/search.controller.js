sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    return BaseController.extend("generated.app.controller.search", {
	...
	_onButtonPress2: function (oEvent) {
		...
		return new ES6Promise.Promise(function(resolve, reject) {
		    ...
		    this.doNavigate("searchresult", oBindingContext, resolve, ""
		    );
		}.bind(this));
	...
	onInit: function () {
        ...
        this.oRouter.getTarget("search").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
