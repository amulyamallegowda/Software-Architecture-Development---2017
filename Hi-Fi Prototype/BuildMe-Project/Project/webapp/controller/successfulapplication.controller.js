sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    return BaseController.extend("generated.app.controller.successfulapplication", {
	...
	_onObjectIdentifierTitlePress: function (oEvent) {
		...
		if (!oPopover) {
		    this.getOwnerComponent().runAsOwner(function () {
		        ...
		        oPopover.setPlacement("Right" || "Auto");
	...
	onInit: function () {
        ...
        this.oRouter.getTarget("successfulapplication").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
