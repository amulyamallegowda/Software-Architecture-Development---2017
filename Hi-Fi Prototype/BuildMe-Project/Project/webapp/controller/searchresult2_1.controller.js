sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    return BaseController.extend("generated.app.controller.searchresult2_1", {
	...
	_onButtonPress12: function (oEvent) {
		...
		return new ES6Promise.Promise(function(resolve, reject) {
		    ...
		    this.doNavigate("login", oBindingContext, resolve, ""
		    );
		}.bind(this));
	...
	onInit: function () {
        ...
        this.oRouter.getTarget("searchresult2_1").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
