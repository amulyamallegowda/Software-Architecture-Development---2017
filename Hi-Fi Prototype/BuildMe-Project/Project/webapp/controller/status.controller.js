sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    return BaseController.extend("generated.app.controller.status", {
	...
	_onUploadCollectionUploadComplete3: function (oEvent) {
	...
	_onUploadCollectionChange3: function (oEvent) {
	...
	_onUploadCollectionTypeMissmatch3: function () {
	...
	_onUploadCollectionFileSizeExceed3: function () {
		return new ES6Promise.Promise(function(fnResolve) {
	...
	_onButtonPress9: function (oEvent) {
		...
		return new ES6Promise.Promise(function(resolve, reject) {
		    ...
		    this.doNavigate("home", oBindingContext, resolve, ""
		    );
		}.bind(this));
	...
	onInit: function () {
        ...
        this.oRouter.getTarget("status").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
